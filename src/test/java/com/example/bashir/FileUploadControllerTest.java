...
public class FileUploadControllerTest {
	...
	@Test
	public void uploadFile_withImageFromUnauthorizedUser_receiveUnathorized() {
	...
	private HttpEntity<MultiValueMap<String, Object>> getRequestEntity() {
		ClassPathResource imageResourse = new ClassPathResource("profile.png");
		MultiValueMap<String , Object> body = new LinkedMultiValueMap<>();
		body.add("file", imageResourse);
